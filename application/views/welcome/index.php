...
<body <?php if(isset($onload)){echo "onload=$onload";}?>>
	...
	<nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Pocket Menu</a>
            </div>
		...
		<!-- Header -->
    <a name="about"></a>
    <div class="intro-header" style="padding-top: 95px;">

    	<div class="container">
        	<img src="<?php echo base_url();?>images/main.png">
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="<?php echo base_url();?>images/Maindish.png" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="<?php echo base_url();?>images/classicmojitoloft.png" alt="">
                </div>
            </div>
    ...
    <div class="content-section-a">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="<?php echo base_url();?>images/CDBtacos.jpg" alt="">
                </div>
            </div>
    ...
    <div class="banner">
        ...
        <div class="container">
        	<img src="<?php echo base_url();?>images/dessert.jpg">
        </div>
        <!-- /.container -->
