...
class App_Controller extends CI_Controller
{
     ...
     * @var string
     */
    public $site_title = '24Hours Service'; //non use
     ...
     * @var string
     */
    public $page_meta_keywords = 'MVC Pattern, bootstrap 3.x, codeigniter';
     ...
     * @var string
     */
    public $page_meta_author = 'Mark, Remy Albert';
    ...
    public function __construct()
    {
        ...
        $this->assets_css = array(
			'common/css/bootstrap/bootstrap.min.css',
			'common/css/animate.min.css',
			'common/css/font-awesome/font-awesome.min.css',
			'common/css/style.css',
            'common/css/main.css'
            );
        $this->assets_js = array(
            'common/js/jQuery/jQuery-2.1.1.js',
            'common/js/pace.min.js',
            'common/js/bootstrap/bootstrap.min.js',
            'common/js/classie.js',
            'common/js/cbpAnimatedHeader.js',
            'common/js/wow.min.js',
            'common/js/inspinia.js'
            );
